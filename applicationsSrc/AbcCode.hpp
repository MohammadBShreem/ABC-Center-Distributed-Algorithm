...
public :
	...
	void myGoFuncFromA(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);
	void myBackFuncFromA(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);
	void myLightFuncFromA(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);

	void myGoFuncFromB(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);
	void myBackFuncFromB(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);
	void myLightFuncFromB(std::shared_ptr<Message>_msg,P2PNetworkInterface *sender);

	void myLightFuncFromC(std::shared_ptr<Message> _msg, P2PNetworkInterface* sender);
